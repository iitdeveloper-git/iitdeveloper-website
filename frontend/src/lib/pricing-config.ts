  ...
  // Technical Services
  {
    ...
    options: [
      ...
      },
      {
        ...
        type: 'multiselect',
        options: [
          { value: 'auth', label: 'User Authentication', priceModifier: 9999 },
          { value: 'payments', label: 'Payment Integration', priceModifier: 14999 },
          { value: 'admin', label: 'Admin Dashboard', priceModifier: 19999 },
          { value: 'api', label: 'REST API', priceModifier: 14999 },
          { value: 'realtime', label: 'Real-time Features', priceModifier: 24999 },
          { value: 'search', label: 'Advanced Search', priceModifier: 9999 },
        ],
      },
      {
        id: 'users',
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        type: 'multiselect',
        options: [
          { value: 'push', label: 'Push Notifications', priceModifier: 9999 },
          { value: 'offline', label: 'Offline Mode', priceModifier: 14999 },
          { value: 'camera', label: 'Camera Integration', priceModifier: 9999 },
          { value: 'location', label: 'GPS/Location', priceModifier: 9999 },
          { value: 'social', label: 'Social Login', priceModifier: 4999 },
        ],
      },
    ],
  },
  ...
  // AI Services
  {
    ...
    options: [
      ...
      },
      {
        ...
        type: 'multiselect',
        options: [
          { value: 'rag', label: 'RAG (Knowledge Base)', priceModifier: 19999 },
          { value: 'voice', label: 'Voice Input/Output', priceModifier: 24999 },
          { value: 'multilang', label: 'Multi-language Support', priceModifier: 14999 },
          { value: 'analytics', label: 'Conversation Analytics', priceModifier: 9999 },
        ],
      },
      {
        id: 'channels',
        ...
        type: 'multiselect',
        options: [
          { value: 'web', label: 'Web Widget', priceModifier: 4999 },
          { value: 'whatsapp', label: 'WhatsApp', priceModifier: 9999 },
          { value: 'slack', label: 'Slack', priceModifier: 6999 },
          { value: 'discord', label: 'Discord', priceModifier: 6999 },
        ],
      },
    ],
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        type: 'select',
        options: [
          { value: 'cloud', label: 'Cloud API', priceModifier: 19999 },
          { value: 'edge', label: 'Edge Deployment', priceModifier: 29999 },
          { value: 'both', label: 'Hybrid', priceModifier: 39999 },
        ],
      },
    ],
  },
  ...
  // Marketing Services
  {
    ...
    options: [
      ...
      },
      {
        ...
        type: 'multiselect',
        options: [
          { value: 'audit', label: 'Technical Audit', priceModifier: 2999 },
          { value: 'keywords', label: 'Keyword Research', priceModifier: 2499 },
          { value: 'content', label: 'Content Optimization', priceModifier: 4999 },
          { value: 'backlinks', label: 'Link Building', priceModifier: 6999 },
        ],
      },
    ],
  },
    ...
    options: [
      {
        ...
        type: 'multiselect',
        options: [
          { value: 'ga', label: 'Google Analytics', priceModifier: 2999 },
          { value: 'fb', label: 'Facebook Ads', priceModifier: 2999 },
          { value: 'google-ads', label: 'Google Ads', priceModifier: 2999 },
          { value: 'custom', label: 'Custom Database', priceModifier: 14999 },
        ],
      },
      {
        id: 'reports',
    ...
    options: [
      ...
      },
      {
        ...
        options: [
          ...
          { value: 'monitoring', label: 'Performance Monitoring', priceModifier: 2499 },
          { value: 'backups', label: 'Automated Backups', priceModifier: 1499 },
          { value: 'fixes', label: 'Bug Fixes', priceModifier: 3999 },
        ],
      },
    ],
  },
  ...
  // ─── AI Services (additional) ────────────────────────────────────────────
  {
    ...
    options: [
      ...
      },
      {
        ...
        options: [
          { value: 'rag', label: 'RAG / Knowledge Base', priceModifier: 19999 },
          { value: 'function-calling', label: 'Tool & Function Calling', priceModifier: 14999 },
          { value: 'multi-modal', label: 'Multi-modal (Vision/Audio)', priceModifier: 24999 },
          { value: 'memory', label: 'Long-term Memory', priceModifier: 19999 },
          { value: 'web-browsing', label: 'Web Browsing & Research', priceModifier: 14999 },
        ],
      },
    ],
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        type: 'multiselect',
        options: [
          { value: 'crm', label: 'CRM (Salesforce / HubSpot)', priceModifier: 14999 },
          { value: 'erp', label: 'ERP Systems', priceModifier: 19999 },
          { value: 'email', label: 'Email / Calendar', priceModifier: 6999 },
          { value: 'storage', label: 'Cloud Storage / Documents', priceModifier: 9999 },
          { value: 'communication', label: 'Slack / Teams / WhatsApp', priceModifier: 9999 },
        ],
      },
      {
        id: 'extras',
        ...
        type: 'multiselect',
        options: [
          { value: 'monitoring', label: 'Monitoring Dashboard', priceModifier: 9999 },
          { value: 'error-handling', label: 'Error Handling & Retry Logic', priceModifier: 6999 },
          { value: 'mcp', label: 'MCP Protocol Support', priceModifier: 14999 },
        ],
      },
    ],
  },
  ...
  // ─── Ecommerce Services ───────────────────────────────────────────────────
  {
    ...
    options: [
      ...
      },
      {
        ...
        type: 'multiselect',
        options: [
          { value: 'payments', label: 'Multi-gateway Payments (Stripe / Razorpay / PayPal)', priceModifier: 9999 },
          { value: 'marketplace', label: 'Marketplace Integration (Amazon / Flipkart)', priceModifier: 19999 },
          { value: 'inventory', label: 'Inventory Management', priceModifier: 14999 },
          { value: 'loyalty', label: 'Loyalty & Rewards Program', priceModifier: 9999 },
          { value: 'analytics', label: 'Sales Analytics Dashboard', priceModifier: 9999 },
        ],
      },
    ],
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        type: 'multiselect',
        options: [
          { value: 'klaviyo', label: 'Klaviyo (Email Marketing)', priceModifier: 4999 },
          { value: 'yotpo', label: 'Yotpo (Reviews & Loyalty)', priceModifier: 3999 },
          { value: 'recharge', label: 'ReCharge (Subscriptions)', priceModifier: 6999 },
          { value: 'gorgias', label: 'Gorgias (Customer Support)', priceModifier: 4999 },
          { value: 'shipping', label: 'Shipping Automation', priceModifier: 4999 },
        ],
      },
      {
        id: 'markets',
  ...
  // ─── DevOps Services ──────────────────────────────────────────────────────
  {
    ...
    options: [
      ...
      },
      {
        ...
        type: 'multiselect',
        options: [
          { value: 'cicd', label: 'CI/CD Pipeline (GitHub Actions / GitLab)', priceModifier: 14999 },
          { value: 'kubernetes', label: 'Kubernetes Orchestration', priceModifier: 39999 },
          { value: 'iac', label: 'Infrastructure as Code (Terraform)', priceModifier: 24999 },
          { value: 'monitoring', label: 'Monitoring & Logging (Prometheus / Grafana)', priceModifier: 14999 },
          { value: 'security', label: 'Security Hardening & WAF', priceModifier: 19999 },
        ],
      },
      {
        id: 'scale',
  ...
  // ─── Design Services ──────────────────────────────────────────────────────
  {
    ...
    options: [
      ...
      },
      {
        ...
        type: 'multiselect',
        options: [
          { value: 'logo', label: 'Logo Design (3 concepts)', priceModifier: 2999 },
          { value: 'guidelines', label: 'Brand Guidelines Document', priceModifier: 4999 },
          { value: 'social', label: 'Social Media Templates (20 designs)', priceModifier: 3999 },
          { value: 'video', label: 'Promo / Launch Video', priceModifier: 9999 },
          { value: 'animation', label: '2D Animation (30s After Effects)', priceModifier: 14999 },
        ],
      },
    ],
  },
  ...
  // ─── CRM Services ─────────────────────────────────────────────────────────
  {
    ...
    options: [
      ...
      },
      {
        ...
        type: 'multiselect',
        options: [
          { value: 'automation', label: 'Process Automation (Flows & Triggers)', priceModifier: 19999 },
          { value: 'integration', label: 'Third-party Integrations', priceModifier: 24999 },
          { value: 'migration', label: 'Data Migration', priceModifier: 29999 },
          { value: 'analytics', label: 'Einstein Analytics & Dashboards', priceModifier: 24999 },
          { value: 'training', label: 'Team Training & Documentation', priceModifier: 9999 },
        ],
      },
    ],
  },
  ...
  // ─── B2B Services ─────────────────────────────────────────────────────────
  {
    ...
    options: [
      ...
      },
      {
        ...
        type: 'multiselect',
        options: [
          { value: 'icp', label: 'Market Research & ICP Definition', priceModifier: 4999 },
          { value: 'outbound', label: 'Outbound Email & LinkedIn Campaigns', priceModifier: 6999 },
          { value: 'content', label: 'Content Marketing & Thought Leadership', priceModifier: 9999 },
          { value: 'pipeline', label: 'Pipeline Analytics & CRM Setup', priceModifier: 5999 },
        ],
      },
    ],
  },
    ...
    options: [
      {
        ...
        type: 'multiselect',
        options: [
          { value: 'google-ads', label: 'Google Ads (Search / Display)', priceModifier: 4999 },
          { value: 'meta', label: 'Meta Ads (Facebook / Instagram)', priceModifier: 4999 },
          { value: 'linkedin', label: 'LinkedIn Ads', priceModifier: 6999 },
          { value: 'youtube', label: 'YouTube Ads', priceModifier: 5999 },
        ],
      },
      {
        id: 'budget',
        ...
        type: 'select',
        options: [
          { value: 'small', label: '< ₹50,000 / month', priceModifier: 1 },
          { value: 'medium', label: '₹50,000 – ₹2,00,000 / month', priceModifier: 1.3 },
          { value: 'large', label: '₹2,00,000 – ₹5,00,000 / month', priceModifier: 1.6 },
          { value: 'enterprise', label: '₹5,00,000+ / month', priceModifier: 2 },
        ],
      },
      {
        id: 'extras',
        ...
        type: 'multiselect',
        options: [
          { value: 'landing-pages', label: 'Landing Page Design & Development', priceModifier: 9999 },
          { value: 'ab-testing', label: 'A/B Testing Setup', priceModifier: 4999 },
          { value: 'email', label: 'Email Automation & Sequences', priceModifier: 6999 },
        ],
      },
    ],
  },
