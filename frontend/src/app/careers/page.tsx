...
export default function CareersPage() {
  ...
  return (
    <main className="min-h-screen bg-background relative overflow-hidden">
      ...
      {/* ── Application Form ── */}
      <section id="apply-form" className="py-20 scroll-mt-28">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <p className="text-xl text-muted-foreground/70 max-w-2xl mx-auto">
              Submit your application below. We read every single one.
            </p>
          </motion.div>
          <CareerApplicationForm preselectedPosition={selectedPosition} />
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              onClick={() => scrollToForm('Other / Open Application')}
